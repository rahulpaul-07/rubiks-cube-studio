...
The repository pins Node.js `24.14.0` in `.nvmrc` and npm `11.9.0` in
`package.json` for reproducible local development. With a compatible Node
Version Manager installed, run `nvm use` from the repository root.
